...
(function(global) {
  ...
  function renderAuditLog(el, n) {
    ...
    var html = '<div class="grx26-panel"><h2>UTU — Audit Log</h2><p class="sub">(Oversight, immutability, trace)</p><h2 style="display:none">Audit Log (recent ' + n + ')</h2><table class="grx26-audit-table"><thead><tr><th>Time</th><th>Event</th><th>Trace ID</th></tr></thead><tbody>';
